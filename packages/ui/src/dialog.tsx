				...
				<div className='grid min-h-full grid-rows-[1fr_auto] justify-items-center sm:grid-rows-[1fr_auto_3fr] sm:p-4'>
					<Headless.DialogPanel
						...
						className={clsx(
							className,
							sizes[size],
							'row-start-2 w-full min-w-0 rounded-t-3xl bg-white p-(--gutter) shadow-lg ring-1 ring-black/10 [--gutter:calc(var(--spacing)*8)] sm:mb-auto sm:rounded-2xl dark:bg-black/90 dark:ring-white/10 forced-colors:outline',
...
export function Title({
	...
	return (
		<Headless.DialogTitle
			{...props}
			className={clsx(className, 'text-balance font-semibold text-black text-lg/6 sm:text-base/6 dark:text-white')}
		/>
	)
}
