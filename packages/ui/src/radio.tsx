...
const colors = {
	'dark/zinc': [
		'[--radio-checked-bg:var(--color-black)]/90 [--radio-checked-border:var(--color-black)]/90 [--radio-checked-indicator:var(--color-white)]',
		'dark:[--radio-checked-bg:var(--color-zinc-600)]',
	],
	'dark/white': [
		'[--radio-checked-bg:var(--color-black)]/90 [--radio-checked-border:var(--color-black)]/90 [--radio-checked-indicator:var(--color-white)]',
		'dark:[--radio-checked-bg:var(--color-white)] dark:[--radio-checked-border:var(--color-black)]/15 dark:[--radio-checked-indicator:var(--color-black)]/90',
	],
	white:
		'[--radio-checked-bg:var(--color-white)] [--radio-checked-border:var(--color-black)]/15 [--radio-checked-indicator:var(--color-black)]/90',
	dark: '[--radio-checked-bg:var(--color-black)]/90 [--radio-checked-border:var(--color-black)]/90 [--radio-checked-indicator:var(--color-white)]',
