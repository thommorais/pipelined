...
const checkboxClasses = tv({
	base: [
		...
		'before:-z-10 before:absolute before:inset-0 before:rounded-[calc(0.3125rem-1px)] before:bg-white before:shadow-sm',
		...
		'dark:border-white/15 dark:group-data-hover:group-data-checked:border-white/5 dark:group-data-checked:border-white/5 dark:group-data-hover:border-white/30',
		...
		'dark:group-data-disabled:border-white/20 dark:group-data-disabled:bg-white/[2.5%] dark:group-data-checked:group-data-disabled:after:hidden dark:group-data-disabled:[--checkbox-check:var(--color-white)]/50',
		// Forced colors mode
	...
	variants: {
		color: {
			'dark/zinc': [
				'[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-black)]/90 [--checkbox-checked-border:var(--color-black)]/90',
				'dark:[--checkbox-checked-bg:var(--color-zinc-600)]',
			],
			'dark/white': [
				'[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-black)]/90 [--checkbox-checked-border:var(--color-black)]/90',
				'dark:[--checkbox-check:var(--color-black)]/90 dark:[--checkbox-checked-bg:var(--color-white)] dark:[--checkbox-checked-border:var(--color-black)]/15',
			],
			white:
				'[--checkbox-check:var(--color-black)]/90 [--checkbox-checked-bg:var(--color-white)] [--checkbox-checked-border:var(--color-black)]/15',
			dark: '[--checkbox-check:var(--color-white)] [--checkbox-checked-bg:var(--color-black)]/90 [--checkbox-checked-border:var(--color-black)]/90',
...
export function Checkbox({ color = 'dark/zinc', ...props }: CheckboxProps) {
	return (
		<Headless.Checkbox
			data-slot='control'
			{...props}
