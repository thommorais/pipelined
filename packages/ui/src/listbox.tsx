		...
		<Headless.Listbox {...props} multiple={false}>
			...
			>
				<Headless.ListboxSelectedOption
					...
					className={clsx([
						...
						// Typography
						'text-left text-base/6 text-black placeholder:text-zinc-500 sm:text-sm/6 dark:text-white forced-colors:text-[CanvasText]',
						// Border
						'border border-black/10 group-data-active:border-black/20 group-data-hover:border-black/20 dark:border-white/10 dark:group-data-active:border-white/20 dark:group-data-hover:border-white/20',
						// Background color
						...
						// Disabled state
						'group-data-disabled:border-black/20 group-data-disabled:opacity-100 dark:group-data-disabled:border-white/15 dark:group-data-disabled:bg-white/[2.5%] dark:group-data-disabled:data-hover:border-white/15',
					])}
				/>
			...
			<Headless.ListboxOptions
				...
				className={clsx(
					...
					// Shadows
					'shadow-lg ring-1 ring-black/10 dark:ring-white/10 dark:ring-inset',
					// Transitions
				...
				return (
					<div
						className={clsx(
							...
							// Typography
							'text-base/6 text-black sm:text-sm/6 dark:text-white forced-colors:text-[CanvasText]',
							// Focus
